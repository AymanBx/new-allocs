...
/// has been defined, to know whether it should be compiled in “replacement malloc” or regular mode. When in USE REPLACEMENT MANAGER mode, your program should make
